...
export interface UserInfo { id: string; email?: { id: string; isVerified: boolean } }

export interface TypeProviderGetResponse {
  accessTokenAPI: {
    url: string
...
export interface TypeInputSignInAndUp {
  providers: TypeProvider[]
}

export interface TypeNormalisedInputSignInAndUp {
  providers: TypeProvider[]
}
