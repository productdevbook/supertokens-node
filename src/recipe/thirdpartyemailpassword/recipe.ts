...
export default class Recipe extends RecipeModule {
  ...
  constructor(
    ...
    const emailPasswordRecipeImplementation = EmailPasswordRecipeImplementation(this.recipeInterfaceImpl)
    /**
  ...
  getAPIsHandled = (): APIHandled[] => {
    const apisHandled = [...this.emailPasswordRecipe.getAPIsHandled()]
  ...
  getAllCORSHeaders = (): string[] => {
    const corsHeaders = [...this.emailPasswordRecipe.getAllCORSHeaders()]
    if (this.thirdPartyRecipe !== undefined)
